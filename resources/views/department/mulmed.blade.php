        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="member">
                    ...
                    <div class="member-info">
                        <h4>Ni Made Ayu Ratna Anjalie</h4>
                        <span>Staff Departemen Multimedia</span>
                        <p>Bertanggung jawab terhadap pelatihan yang berkaitan dengan Multimedia serta menghasilkan
                            produk dan portofolio.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                <div class="member">
                    ...
                    <div class="member-info">
                        <h4>Khilda Salsabila Azka</h4>
                        <span>Kepala Departemen Multimedia</span>
                        <p>Bertanggung jawab terhadap pelatihan yang berkaitan dengan Multimedia serta menghasilkan
                            produk dan portofolio.</p>
                    </div>
                </div>
